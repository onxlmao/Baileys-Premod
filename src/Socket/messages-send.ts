        ...
        const relayMessage = async(
                ...
                await authState.keys.transaction(
                        async() => {
                                ...
                                const isTemplateMsg = !!(
                                        message?.viewOnceMessage?.message?.templateMessage ||
                                        message?.viewOnceMessageV2?.message?.templateMessage ||
                                        message?.viewOnceMessageV2Extension?.message?.templateMessage ||
                                ...
                                const isFlowResponseMsg = !!(
                                        message?.interactiveResponseMessage ||
                                        message?.viewOnceMessage?.message?.interactiveResponseMessage ||
                                        message?.viewOnceMessageV2?.message?.interactiveResponseMessage ||
                                        message?.viewOnceMessageV2Extension?.message?.interactiveResponseMessage
                                )
