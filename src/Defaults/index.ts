...
export const DEFAULT_CONNECTION_CONFIG: SocketConfig = {
        ...
        // Enhanced media upload settings
...
export const MIN_UPLOAD_INTERVAL = 30_000 // 30 seconds minimum between pre-key uploads

export const UPLOAD_TIMEOUT = 60_000 // 60 seconds timeout for pre-key upload
