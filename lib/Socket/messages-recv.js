...
const makeMessagesRecvSocket = (config) => {
    ...
    const sendRetryRequest = async (node, forceIncludeKeys = false) => {
        ...
        if (retryCount === 1) {
            ...
            logger.debug(`sendRetryRequest: requested placeholder resend (${requestId}) for message ${msgId}`);
        }
        ...
        switch (nodeType) {
            ...
            case 'picture':
                ...
                if ((0, WABinary_1.isJidGroup)(from)) {
                    ...
                    result.participant = pictureNode === null || pictureNode === void 0 ? void 0 : pictureNode.attrs.author;
                    result.key = {
                        ...result.key || {},
