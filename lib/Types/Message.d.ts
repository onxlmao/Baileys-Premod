...
type AIable = {
    /** Enable AI icon (sparkle) on the message.
     *  Set to true for default AI styling,
     *  or provide a custom BotMetadata object for advanced configuration */
    ai?: boolean | proto.IBotMetadata;
};
type Buttonable = {
...
export type AnyMediaMessageContent = (({
...
} & Mentionable & Contextable & Buttonable & Templatable & Interactiveable & Shopable & Cardsable & WithDimensions & AIable) | ({
    video: WAMediaUpload;
    caption?: string;
    gifPlayback?: boolean;
    jpegThumbnail?: string;
    ...
    fileName?: string;
    caption?: string;
} & Contextable & Buttonable & Templatable & Interactiveable & Shopable & Cardsable & AIable)) & {
    mimetype?: string;
} & Editable & AIable;
...
export type AnyRegularMessageContent = (({
...
} & Mentionable & Contextable & Buttonable & Templatable & Interactiveable & Shopable & Cardsable & Listable & Editable & AIable) | AnyMediaMessageContent | ({
    ...
    album: AlbumMedia[];
    caption?: string;
} & Mentionable & Contextable & Editable)) & ViewOnce & AIable;
