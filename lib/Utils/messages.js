...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        (_q = message.poll).selectableCount || (_q.selectableCount = 0);
        (_r = message.poll).toAnnouncementGroup || (_r.toAnnouncementGroup = false);
    ...
    if ('ai' in message && !!message.ai) {
        ...
        m.messageContextInfo = {
            ...
            botMessageSecret: ((_p = m.messageContextInfo) === null || _p === void 0 ? void 0 : _p.botMessageSecret) || (0, crypto_1.randomBytes)(32),
            botMetadata,
        };
    }
...
const extractMessageContent = (content) => {
    ...
    if (content === null || content === void 0 ? void 0 : content.interactiveMessage) {
        ...
        if (interactive.carouselMessage) {
            ...
            if (cards === null || cards === void 0 ? void 0 : cards.length) {
                // extract text from the first card as representative content
    ...
    if (content === null || content === void 0 ? void 0 : content.interactiveResponseMessage) {
        ...
        if ((_r = response.body) === null || _r === void 0 ? void 0 : _r.text) {
            return { conversation: response.body.text };
        }
        // Fallback: parse nativeFlowResponseMessage paramsJson for ID/title
        if ((_s = response.nativeFlowResponseMessage) === null || _s === void 0 ? void 0 : _s.paramsJson) {
            try {
            ...
            catch ( /* invalid JSON, skip */_t) { /* invalid JSON, skip */ }
        }
    }
