...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const obj = Types_1.WAProto.Message.fromObject({
        [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject({
            ...
            fileSha256,
            fileLength,
            mediaKeyTimestamp: (handle || !mediaKey) ? undefined : (0, generics_1.unixTimestampSeconds)(),
            ...uploadData,
            media: undefined
        })
    });
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('ai' in message && !!message.ai) {
        const botMetadata = typeof message.ai === 'object'
            ? message.ai
            : {
        ...
        m.messageContextInfo = {
            ...
            botMessageSecret: (m.messageContextInfo && m.messageContextInfo.botMessageSecret) || (0, crypto_1.randomBytes)(32),
            botMetadata,
        };
    }
...
const extractMessageContent = (content) => {
    ...
    // Handle interactiveMessage extraction - extract body text and media
    // Supports nativeFlowMessage (buttons), shopStorefrontMessage (shop), carouselMessage (carousel)
    if (content === null || content === void 0 ? void 0 : content.interactiveMessage) {
        const interactive = content.interactiveMessage;
        // Native flow buttons - extract body text as primary content
        if ((_h = (_g = interactive.nativeFlowMessage) === null || _g === void 0 ? void 0 : _g.buttons) === null || _h === void 0 ? void 0 : _h.length) {
            if ((_j = interactive.body) === null || _j === void 0 ? void 0 : _j.text) {
                return { conversation: interactive.body.text };
            }
            if ((_k = interactive.header) === null || _k === void 0 ? void 0 : _k.title) {
                return { conversation: interactive.header.title };
            }
        }
        // Carousel message - extract from carousel cards
        if (interactive.carouselMessage) {
            ...
            if (cards === null || cards === void 0 ? void 0 : cards.length) {
                ...
                if ((_l = firstCard.body) === null || _l === void 0 ? void 0 : _l.text) {
                    return { conversation: firstCard.body.text };
                }
            }
        }
        // Shop storefront message - extract body text
        if (interactive.shopStorefrontMessage) {
            if ((_m = interactive.body) === null || _m === void 0 ? void 0 : _m.text) {
                return { conversation: interactive.body.text };
            }
            if ((_o = interactive.header) === null || _o === void 0 ? void 0 : _o.title) {
                return { conversation: interactive.header.title };
            }
        }
        // Extract media from interactive message headers
        if (interactive.header) {
            if (interactive.header.imageMessage) {
                return { imageMessage: interactive.header.imageMessage };
            }
            else if (interactive.header.videoMessage) {
                return { videoMessage: interactive.header.videoMessage };
            }
            else if (interactive.header.documentMessage) {
                return { documentMessage: interactive.header.documentMessage };
            }
        }
        // Fallback to body/header text for any interactive sub-type
        if ((_p = interactive.body) === null || _p === void 0 ? void 0 : _p.text) {
            return { conversation: interactive.body.text };
        }
        if ((_q = interactive.header) === null || _q === void 0 ? void 0 : _q.title) {
            return { conversation: interactive.header.title };
        }
    }
    // Handle interactiveResponseMessage extraction - extract body text from button responses
    // When a user clicks a native flow button, WhatsApp sends an interactiveResponseMessage
    // with body.text (display text) and nativeFlowResponseMessage.paramsJson (button data)
    if (content === null || content === void 0 ? void 0 : content.interactiveResponseMessage) {
        const response = content.interactiveResponseMessage;
        // Primary: body text from the response
        if ((_o = response.body) === null || _o === void 0 ? void 0 : _o.text) {
            return { conversation: response.body.text };
        }
        // Fallback: parse nativeFlowResponseMessage paramsJson for ID/title
        if ((_p = (_q = response.nativeFlowResponseMessage) === null || _q === void 0 ? void 0 : _q.paramsJson) === null || _p === void 0 ? void 0 : _p.length) {
            try {
    ...
    if ((_r = content === null || content === void 0 ? void 0 : content.nativeFlowResponseMessage) === null || _r === void 0 ? void 0 : _r.paramsJson) {
        try {
            const nativeParams = JSON.parse(content.nativeFlowResponseMessage.paramsJson);
            if (nativeParams.id) {
                return { conversation: nativeParams.id };
            }
            if (nativeParams.title) {
                return { conversation: nativeParams.title };
            }
            if (nativeParams.description) {
                return { conversation: nativeParams.description };
            }
        }
        catch (_s) { /* invalid JSON, skip */ }
    }
    ...
    if ((_t = content === null || content === void 0 ? void 0 : content.carouselCardResponseMessage) === null || _t === void 0 ? void 0 : _t.rowId) {
        return { conversation: content.carouselCardResponseMessage.rowId };
    }
    if ((_u = content === null || content === void 0 ? void 0 : content.carouselCardResponseMessage) === null || _u === void 0 ? void 0 : _u.cardIndex !== undefined && (_v = content.carouselCardResponseMessage) === null || _v === void 0 ? void 0 : _v.cardIndex !== null) {
        return { conversation: `card:${content.carouselCardResponseMessage.cardIndex}` };
    }
    // Handle buttonsResponseMessage extraction - extract selected button text
    if (content === null || content === void 0 ? void 0 : content.buttonsResponseMessage) {
        const btnResponse = content.buttonsResponseMessage;
        if (btnResponse.selectedDisplayText) {
            return { conversation: btnResponse.selectedDisplayText };
        }
    }
    // Handle listResponseMessage extraction - extract list reply text
    if (content === null || content === void 0 ? void 0 : content.listResponseMessage) {
        const listResponse = content.listResponseMessage;
        if (listResponse.title) {
            return { conversation: listResponse.title };
        }
        if (listResponse.description) {
            return { conversation: listResponse.description };
        }
    }
    // Handle templateButtonReplyMessage extraction - extract reply text
    if (content === null || content === void 0 ? void 0 : content.templateButtonReplyMessage) {
        const tmplResponse = content.templateButtonReplyMessage;
        if (tmplResponse.selectedDisplayText) {
            return { conversation: tmplResponse.selectedDisplayText };
        }
    }
    return content;
};
